...
class SQueue{
     ...
     ******************************************/
  //Merging logic depending on heap structure                                                                                                                                     
  Post* merge(Post* h1, Post* h2);

  //Deep copy                                                                                                                                                                     
  Post* copyTree(const Post* root);

  //Deallocate                                                                                                                                                                    
  void clearTree(Post* root);

  //In-order print                                                                                                                                                                
  void printPreOrder(Post* root) const;

  //Used in getNextPost                                                                                                                                                           
  bool comparePosts(Post* a, Post* b) const;


  //Traverse heap and copy nodes into a static array for rebuilding                                                                                                               
  void collectPosts(Post* root, Post* arr[], int& index, int maxSize);
};
#endif
